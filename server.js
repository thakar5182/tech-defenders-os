...
/* ---------------- API routes ---------------- */
app.get('/api/health', (req, res) => res.json({ ok: true, name: 'Tech Defenders OS', version: '4.1.0', storage: store.DATA_DIR, time: new Date().toISOString() }));
...
if (require.main === module) {
  ...
  const server = app.listen(PORT, () => {
    console.log('');
    console.log('  ================================================');
    console.log('   TECH DEFENDERS OS v4.1.0');
